...
public static void main(String[] args) {
	...
	productList.add(new Product(5, "Apple Laptop",900000));
	
	productList.stream().filter(p->p.price > 25000) // filter
	.forEach(pr->System.out.println("Total Price Calculate: " + pr.price)); // iterating
